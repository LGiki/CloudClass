<template>
  <div class="app-container">
    ...
    <el-dialog :title="`${isAdd ? '创建' : '编辑'}系统参数`" :visible.sync="dialogFormVisible" width="70%">
      <el-form :model="parameterDetail">
        <el-form-item v-if="!isAdd" label="参数ID">
        ...
        <el-form-item label="参数介绍">
          <el-input v-model="parameterDetail.description" placeholder="请输入参数介绍"/>
        </el-form-item>
...
<script>
import {getSystemParameter, addSystemParameter, updateSystemParameter, deleteSystemParameter} from '@/api/system'
